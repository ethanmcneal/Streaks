...
UserStreak.create(user_id: "1", streak_id: "2", status: 'ongoing', media: "")
UserStreak.create(user_id: "1", streak_id: "3", status: 'ongoing', media: "")
UserStreak.create(user_id: "1", streak_id: "4", status: 'ongoing', media: "")
UserStreak.create(user_id: "1", streak_id: "5", status: 'ongoing', media: "")
UserStreak.create(user_id: "1", streak_id: "6", status: 'upcoming', media: "")

UserStreak.create(user_id: "2", streak_id: "1", status: 'ongoing', media: "")
UserStreak.create(user_id: "2", streak_id: "2", status: 'ongoing', media: "")
UserStreak.create(user_id: "2", streak_id: "3", status: 'ongoing', media: "")
UserStreak.create(user_id: "2", streak_id: "4", status: 'ongoing', media: "")
UserStreak.create(user_id: "2", streak_id: "5", status: 'ongoing', media: "")
...
UserStreak.create(user_id: "4", streak_id: "3", status: 'ongoing', media: "")
